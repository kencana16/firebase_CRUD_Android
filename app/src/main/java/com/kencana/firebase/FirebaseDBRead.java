...
import static com.kencana.firebase.R.id.rv_barang;

public class FirebaseDBRead extends AppCompatActivity implements BarangAdapter.FirebaseDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvView = (RecyclerView) findViewById(rv_barang);
        ...
        database.child("barang").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                adapter = new BarangAdapter(daftarBarang, FirebaseDBRead.this);
        ...
        getSupportActionBar().setTitle("Lihat Data");
    }
    ...
    public void onDeleteData(Barang barang, int position) {
         ...
         */
        if(database!=null){
            database.child("barang").child(barang.getKey())
                    .removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(FirebaseDBRead.this,"success delete", Toast.LENGTH_LONG).show();
            }
        });
